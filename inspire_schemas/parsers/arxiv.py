...
class ArxivParser(object):
    ...
    def parse(self):
        ...
        normalized_categories = [classify_field(arxiv_cat) for arxiv_cat in self.arxiv_categories]
    ...
    def dois(self):
        ...
        dois = [{"doi": value, "material": "publication"} for value in doi_values_splitted]
