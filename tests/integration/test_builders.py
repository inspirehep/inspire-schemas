...
def test_literature_builder_valid_record(input_data_hep, expected_data_hep):
    ...
    builder.add_accelerator_experiments_legacy_name(legacy_name=input_data_hep["legacy_name"])
    ...
    builder.add_book_series(title=input_data_hep["title"], volume=input_data_hep["book_volume"])
