...
def test_add_raw_affiliation_ror_detection(subschema):
    ...
    assert (
        validate(
            builder.obj["affiliations_identifiers"],
            subschema["properties"]["affiliations_identifiers"],
        )
        is None
    )
    assert (
        validate(builder.obj["raw_affiliations"], subschema["properties"]["raw_affiliations"])
        is None
    )
