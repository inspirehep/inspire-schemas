...
def test_add_url_with_description():
    ...
    expected = [{"value": "https://www.example.com", "description": "this is an example"}]
    result = author.obj["urls"]
...
def test_add_linkedin():
    ...
    expected = [{"value": "https://www.linkedin.com/in/example-12345/", "schema": "LINKEDIN"}]
...
def test_add_institution_sorts_by_current():
    ...
    author.add_institution(institution="First University", start_date="1950-02-01", current=True)
...
def test_add_institution_sorts_by_start_date():
    ...
    author.add_institution(institution="Colgate University", start_date="1994-02-01", hidden=True)
...
def test_add_institution_normalizes_start_date():
    ...
    author = AuthorBuilder()
    author.add_institution(institution="Colgate University", start_date="February 1 1994")
...
def test_add_advisor_normalizes_name():
    ...
    expected = [{"name": "Torres, Riccardo, Jr.", "curated_relation": False, "hidden": False}]
    result = author.obj["advisors"]
